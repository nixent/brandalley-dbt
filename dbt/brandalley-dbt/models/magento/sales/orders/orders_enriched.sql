...
select
  ...
  o.days_since_signup,
  o.coupon_code,
  coalesce(if(contains_substr(o.coupon_code, ','), o.coupon_code, sr.name), o.coupon_code)              as coupon_name,
  src.type                                                                                              as coupon_type,
  coalesce(src.coupon_type_label, sr.name, if(contains_substr(o.coupon_code, ','), 'Multiple Codes', o.coupon_code))  as coupon_type_label,
