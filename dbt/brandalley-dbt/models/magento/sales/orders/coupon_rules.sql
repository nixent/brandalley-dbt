...
sfo.increment_id as order_id, sfo.status, sfo.base_discount_amount, sfo.base_discount_invoiced, sfo.discount_description, timestamp(sfo.created_at) as order_date,
