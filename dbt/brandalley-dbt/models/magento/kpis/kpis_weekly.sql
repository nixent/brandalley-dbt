...
with order_stats as (
    select
        date_trunc(datetime(created_at, "Europe/London"), week(monday))                  as order_created_at_week,
        ba_site,
...
customer_stats as (
    select
        date_trunc(datetime(signed_up_at, "Europe/London"), week(monday))           as customer_created_at_week,
        ba_site,
...
order_line_stats as (
    select
        date_trunc(datetime(o.created_at, "Europe/London"), week(monday))                                  as order_created_at_week,
        ol.ba_site,
