...
refund_stats as (
    select
        date_trunc(datetime(sfc.created_at, "Europe/London"), month)       as order_created_at_month,
...
shipping_stats as (
    select
        date_trunc(datetime(order_date, "Europe/London"), month) as order_created_at_month,
