...
select
    ...
    title,
    carrier_code,
    datetime(cast(created_at as timestamp), "Europe/London") as created_at,
    datetime(cast(updated_at as timestamp), "Europe/London") as updated_at,    
...
select
    ...
    title,
    carrier_code,
    datetime(created_at, "Europe/London") as created_at,
    datetime(updated_at, "Europe/London") as updated_at,
    _streamkap_source_ts_ms,
    _streamkap_ts_ms,
    _streamkap_offset,
    _streamkap_loaded_at_ts,
