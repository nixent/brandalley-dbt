...
with order_stats as (
    select
        date_trunc(if(ba_site = 'FR',datetime(created_at, "Europe/Paris"),datetime(created_at, "Europe/London")), quarter)                         as order_created_at_quarter,
        ba_site,
...
customer_stats as (
    select
        date_trunc(if(ba_site = 'FR',datetime(signed_up_at, "Europe/Paris"),datetime(signed_up_at, "Europe/London")), quarter)           as customer_created_at_quarter,
        ba_site,
...
refund_stats as (
    select
        date_trunc(if(sfc.ba_site = 'FR',datetime(timestamp(sfc.created_at), "Europe/Paris"),datetime(timestamp(sfc.created_at), "Europe/London")), quarter)       as order_created_at_quarter,
        sfc.ba_site,
...
shipping_stats as (
    select
        date_trunc(if(ba_site = 'FR',datetime(timestamp(order_date), "Europe/Paris"),datetime(timestamp(order_date), "Europe/London")), quarter) as order_created_at_quarter,
        ba_site,
...
order_line_stats as (
    select
        date_trunc(if(o.ba_site = 'FR',datetime(o.created_at, "Europe/Paris"),datetime(o.created_at, "Europe/London")), quarter)                                         as order_created_at_quarter,
        ol.ba_site,
